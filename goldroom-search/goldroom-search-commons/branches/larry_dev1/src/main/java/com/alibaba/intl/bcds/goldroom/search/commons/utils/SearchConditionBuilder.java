...
public class SearchConditionBuilder {
	...
	public SearchConditionBuilder addRange(String field, String min, String max,boolean isAnd) {
		...
		sb.append(field).append(":[").append(min).append(" TO ")
				.append(max).append("]");
		return this;
	}
	...
	public SearchConditionBuilder addDateRange(String field, Date startTime,
			Date endTime, boolean isAnd) {
		if(isAnd){
			sb.append(" +");
		}else {
			sb.append(" ");
		}
		sb.append(field).append(":[").append(dateToString(startTime)).append(" TO ")
				.append(dateToString(endTime)).append("]");
		return this;
	}
