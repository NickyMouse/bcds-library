...
import com.alibaba.intl.goldroom.flex.dataobject.LendingResult;
...
{      
    ...
    public function _Super_LendService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "listLendingByBookItemId");
		 operation.resultType = com.alibaba.intl.goldroom.flex.dataobject.LendingResult; 		 
        operations["listLendingByBookItemId"] = operation;

        com.alibaba.intl.goldroom.flex.dataobject.LendingResult._initRemoteClassAlias();
