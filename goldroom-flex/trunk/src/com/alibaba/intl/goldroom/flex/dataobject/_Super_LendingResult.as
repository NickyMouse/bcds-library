...
public class _Super_LendingResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        com.alibaba.intl.goldroom.flex.dataobject.Lending.initRemoteClassAliasSingleChild();
	...
	model_internal var _internal_lendingList_leaf:com.alibaba.intl.goldroom.flex.dataobject.Lending;
