...
internal class _BookSearchEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("bookOwners", "bookImgUrl", "bookPages", "bookPublisher", "itemAddTime", "bookEdition", "itemFirstAddTime", "bookAuthor", "bookIsbn", "bookPublishTime", "bookInfoId", "bookDescription", "bookCategoryId", "bookTags", "bookTranslator", "bookName");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("bookOwners", "bookImgUrl", "bookPages", "bookPublisher", "itemAddTime", "bookEdition", "itemFirstAddTime", "bookAuthor", "bookIsbn", "bookPublishTime", "bookInfoId", "bookDescription", "bookCategoryId", "bookTags", "bookTranslator", "bookName");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("bookOwners", "bookImgUrl", "bookPages", "bookPublisher", "itemAddTime", "bookEdition", "itemFirstAddTime", "bookAuthor", "bookIsbn", "bookPublishTime", "bookInfoId", "bookDescription", "bookCategoryId", "bookTags", "bookTranslator", "bookName");
