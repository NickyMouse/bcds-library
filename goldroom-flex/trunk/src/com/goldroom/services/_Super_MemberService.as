...
{      
    ...
    public function _Super_MemberService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "listMemberByStatus");
		 operation.resultElementType = com.goldroom.dataobject.Member;
        operations["listMemberByStatus"] = operation;

        com.goldroom.dataobject.Member._initRemoteClassAlias();
        operation = new mx.rpc.remoting.Operation(null, "applyMember");
		 operation.resultType = com.goldroom.dataobject.Member; 		 
        ...
        operation = new mx.rpc.remoting.Operation(null, "forgetPassword");
		 operation.resultType = Boolean; 		 
        operations["forgetPassword"] = operation;
	...
	/**
	  * This method is a generated wrapper used to call the 'listMemberByStatus' operation. It returns an mx.rpc.AsyncToken whose 
	  ...
	  */          
	public function listMemberByStatus(arg0:String) : mx.rpc.AsyncToken
	{
		var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("listMemberByStatus");
	...
	/**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function applyMember(arg0:com.goldroom.dataobject.Member) : mx.rpc.AsyncToken
	{
	...
	/**
	  * This method is a generated wrapper used to call the 'forgetPassword' operation. It returns an mx.rpc.AsyncToken whose 
	  * result property will be populated with the result of the operation when the server response is received. 
	  * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
	  * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function forgetPassword(arg0:String, arg1:String) : mx.rpc.AsyncToken
	{
		var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("forgetPassword");
	...
	/**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function updateMemberByLoginId(arg0:com.goldroom.dataobject.Member) : mx.rpc.AsyncToken
	{
