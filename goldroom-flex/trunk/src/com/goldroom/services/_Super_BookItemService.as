...
import com.goldroom.dataobject.BookItemResult;
...
{      
    ...
    public function _Super_BookItemService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "listBookItemsByLoginIdsAndBookInfoId");
		 operation.resultElementType = com.goldroom.dataobject.BookItem;
        operations["listBookItemsByLoginIdsAndBookInfoId"] = operation;

        com.goldroom.dataobject.BookItem._initRemoteClassAlias();
        operation = new mx.rpc.remoting.Operation(null, "getBookDetailByIdAndOwner");
		 operation.resultType = com.goldroom.dataobject.BookItem; 		 
        ...
        operation = new mx.rpc.remoting.Operation(null, "listBookItemsByLoginIdAndState");
		 operation.resultType = com.goldroom.dataobject.BookItemResult; 		 
        operations["listBookItemsByLoginIdAndState"] = operation;

        com.goldroom.dataobject.BookItemResult._initRemoteClassAlias();
	...
	/**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function addBookItem(arg0:com.goldroom.dataobject.BookItem) : mx.rpc.AsyncToken
	{
