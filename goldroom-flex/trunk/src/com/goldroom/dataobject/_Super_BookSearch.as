...
public class _Super_BookSearch extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
	...
	private var _internal_hasEbook : String;
	...
	[Bindable(event="propertyChange")] 
    public function get hasEbook() : String    
    {
            return _internal_hasEbook;
    }    
	[Bindable(event="propertyChange")] 
    ...
    public function set hasEbook(value:String) : void 
    {    	
        var recalcValid:Boolean = false;
    	
    	
    	var oldValue:String = _internal_hasEbook;               
        if (oldValue !== value)
        {
            _internal_hasEbook = value;
        	this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "hasEbook", oldValue, _internal_hasEbook));
        }    	     
