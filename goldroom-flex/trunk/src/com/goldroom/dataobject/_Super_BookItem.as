...
public class _Super_BookItem extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
	...
	private var _internal_bookInfo : com.goldroom.dataobject.BookInfo;
	...
	[Bindable(event="propertyChange")] 
    public function get bookInfo() : com.goldroom.dataobject.BookInfo    
    {
    ...
    public function set bookInfo(value:com.goldroom.dataobject.BookInfo) : void 
    {    	
        var recalcValid:Boolean = false;
    	...
    	var oldValue:com.goldroom.dataobject.BookInfo = _internal_bookInfo;               
        if (oldValue !== value)
        {
