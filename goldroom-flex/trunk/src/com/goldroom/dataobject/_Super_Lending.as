 ...
 * of this value object you may modify the generated sub-class of this class - Lending.as.
 */
...
[ExcludeClass]
public class _Super_Lending extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("com.alibaba.intl.goldroom.dataobject.Lending") == null)
            {
                flash.net.registerClassAlias("com.alibaba.intl.goldroom.dataobject.Lending", cz);
            } 
        }
        catch (e:Error) 
        {
	...
	model_internal var _dminternal_model : _LendingEntityMetadata;
	...
	private var _internal_bookItem : com.goldroom.dataobject.BookItem;
	...
	private var _internal_subscriber : com.goldroom.dataobject.Member;
	private var _internal_realReturnTime : Date;
	...
	public function _Super_Lending() 
	{	
		_model = new _LendingEntityMetadata(this);
	...
	[Bindable(event="propertyChange")] 
    public function get bookItem() : com.goldroom.dataobject.BookItem    
    {
	...
	[Bindable(event="propertyChange")] 
    public function get subscriber() : com.goldroom.dataobject.Member    
    {
            return _internal_subscriber;
    }    
	[Bindable(event="propertyChange")] 
    public function get realReturnTime() : Date    
    {
            return _internal_realReturnTime;
    }    
    ...
    public function set bookItem(value:com.goldroom.dataobject.BookItem) : void 
    {    	
        var recalcValid:Boolean = false;
    	
    	
    	var oldValue:com.goldroom.dataobject.BookItem = _internal_bookItem;               
        if (oldValue !== value)
        {
    ...
    public function set subscriber(value:com.goldroom.dataobject.Member) : void 
    {    	
        var recalcValid:Boolean = false;
    	
    	
    	var oldValue:com.goldroom.dataobject.Member = _internal_subscriber;               
        if (oldValue !== value)
        {
    ...
    public function set realReturnTime(value:Date) : void 
    {    	
        var recalcValid:Boolean = false;
    	
    	
    	var oldValue:Date = _internal_realReturnTime;               
        if (oldValue !== value)
        {
            _internal_realReturnTime = value;
        	this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "realReturnTime", oldValue, _internal_realReturnTime));
        }    	     
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    [Transient] 
	[Bindable(event="propertyChange")] 
    public function get _model() : _LendingEntityMetadata
    {
		return model_internal::_dminternal_model;              
    }	
    
    public function set _model(value : _LendingEntityMetadata) : void       
    {
    	var oldValue : _LendingEntityMetadata = model_internal::_dminternal_model;               
        if (oldValue !== value)
        {
