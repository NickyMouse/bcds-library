...
public class MemberLogDAOImpl extends SqlMapClientDaoSupport implements MemberLogDAO {

    public int deleteByPrimaryKey(Integer id) throws SQLException {
        MemberLog key = new MemberLog();
        key.setId(id);
        int rows = getSqlMapClientTemplate().delete("MEMBER_LOG.deleteByPrimaryKey", key);
        return rows;
    }

    /**
     * This method was generated by Apache iBATIS ibator. This method corresponds to the database table MEMBER_LOG
     * 
    ...
    public MemberLog selectByPrimaryKey(Integer id) throws SQLException {
        MemberLog key = new MemberLog();
        key.setId(id);
        MemberLog record = (MemberLog) getSqlMapClientTemplate().queryForObject("MEMBER_LOG.selectByPrimaryKey", key);
        return record;
    }

    public int updateByPrimaryKeySelective(MemberLog record) throws SQLException {
        int rows = getSqlMapClientTemplate().update("MEMBER_LOG.updateByPrimaryKeySelective", record);
        return rows;
    }

    public int updateByPrimaryKey(MemberLog record) throws SQLException {
        int rows = getSqlMapClientTemplate().update("MEMBER_LOG.updateByPrimaryKey", record);
        return rows;
    }
