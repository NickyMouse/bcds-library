...
public class BookInfoService {
	...
	public BookSearchResult searchBookByKeyword(String keyword,
			SearchBookType type, int page, int pageSize) {
		BookSearchQueryObject obj = bookSearchService.searchBookByKeyword(
				keyword, type, (page - 1) * pageSize, pageSize);
		return new BookSearchResult(obj.getResultList(), obj.getTotalCount());

	}

	public BookSearchResult searchBookByTime(Date startTime, Date endTime,
			SearchBookType type, int page, int pageSize) {
		BookSearchQueryObject obj = bookSearchService.searchBookByTime(
				startTime, endTime, type, (page - 1) * pageSize, pageSize);
		return new BookSearchResult(obj.getResultList(), obj.getTotalCount());
	}
	...
	public BookSearchResult advancedBookSearch(String bookName,
			String publisher, String isbn, String description,
		...
		BookSearchQueryObject obj = bookSearchService.advancedBookSearch(
				option, SearchBookType.ALL, (page - 1) * pageSize, pageSize);
		return new BookSearchResult(obj.getResultList(), obj.getTotalCount());
	}

	public BookSearchResult listAllBook(SearchBookType type, int page,
			int pageSize) {
		BookSearchQueryObject obj = bookSearchService.listAllBook(type,
				(page - 1) * pageSize, pageSize);
		return new BookSearchResult(obj.getResultList(), obj.getTotalCount());
	}

	public BookSearchResult searchBookByInfoIds(List<Integer> infoIdlist) {
		BookSearchQueryObject obj = bookSearchService
				.searchBookByInfoIds(infoIdlist);
		return new BookSearchResult(obj.getResultList(), obj.getTotalCount());
	}

	public BookSearchResult searchBookByOwnersAndKeyword(String loginId,
			String keyword, int page, int pageSize) {
		BookSearchQueryObject obj = bookSearchService
				.searchBookByOwnersAndKeyword(loginId, keyword, (page - 1)
						* pageSize, pageSize);
		return new BookSearchResult(obj.getResultList(), obj.getTotalCount());
	}
