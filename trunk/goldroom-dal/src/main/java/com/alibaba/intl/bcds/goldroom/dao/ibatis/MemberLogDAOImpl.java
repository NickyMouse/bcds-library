...
public class MemberLogDAOImpl extends SqlMapClientDaoSupport implements MemberLogDAO {
    ...
    public MemberLogDAOImpl(SqlMapClient sqlMapClient) {
    ...
    public MemberLog selectByPrimaryKey(Integer id) throws SQLException {
        MemberLog key = new MemberLog();
        key.setId(id);
        MemberLog record = (MemberLog) getSqlMapClientTemplate().queryForObject(
                "MEMBER_LOG.selectByPrimaryKey", key);
        return record;
    }
    ...
    public int updateByPrimaryKeySelective(MemberLog record) throws SQLException {
        int rows = getSqlMapClientTemplate().update("MEMBER_LOG.updateByPrimaryKeySelective",
                record);
        return rows;
    }
