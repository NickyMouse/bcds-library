...
public class LendingDaoImpl extends SqlMapClientDaoSupport implements LendingDao {
    ...
    /*
     * (non-Javadoc)
     * @see com.alibaba.intl.bcds.goldroom.dao.LendingDao#cutLendingToLog(com.alibaba
    ...
    /*
     * (non-Javadoc)
     * @see com.alibaba.intl.bcds.goldroom.dao.LendingDao#insert(com.alibaba.intl .bcds.goldroom.dataobject.Lending)
     */
    @Override
    ...
    public List<LendingWithExpireDays> listLendingWithExpireDays(boolean isExpire, int skipResult, int pageSize) {
        ...
        return getSqlMapClientTemplate().queryForList("LENDING.listLendingWithExpireDays", param);
    }
}
