...
{      
    ...
    public function _Super_CommentService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "listAll");
		 operation.resultElementType = com.goldroom.valueObjects.Comment;
        operations["listAll"] = operation;

        com.goldroom.valueObjects.Comment._initRemoteClassAlias();
        operation = new mx.rpc.remoting.Operation(null, "listBookCommentByLoginId");
		 operation.resultElementType = com.goldroom.valueObjects.Comment;
        operations["listBookCommentByLoginId"] = operation;

        com.goldroom.valueObjects.Comment._initRemoteClassAlias();
        operation = new mx.rpc.remoting.Operation(null, "deleteCommentById");
		 operation.resultType = Boolean; 		 
        operations["deleteCommentById"] = operation;
	...
	/**
	  * This method is a generated wrapper used to call the 'deleteCommentById' operation. It returns an mx.rpc.AsyncToken whose 
	  * result property will be populated with the result of the operation when the server response is received. 
	  * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
	  * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function deleteCommentById(arg0:int) : mx.rpc.AsyncToken
	{
		var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("deleteCommentById");
	...
	/**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function postComment(arg0:com.goldroom.valueObjects.Comment) : mx.rpc.AsyncToken
	{
