...
import com.goldroom.valueObjects.Member;
...
{      
    ...
    public function _Super_MemberService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "listMemberByStatus");
		 operation.resultElementType = com.goldroom.valueObjects.Member;
        operations["listMemberByStatus"] = operation;

        com.goldroom.valueObjects.Member._initRemoteClassAlias();
        operation = new mx.rpc.remoting.Operation(null, "applyMember");
		 operation.resultType = com.goldroom.valueObjects.Member; 		 
	...
	/**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function applyMember(arg0:com.goldroom.valueObjects.Member) : mx.rpc.AsyncToken
	{
	...
	/**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
	  */          
	public function updateMemberByLoginId(arg0:com.goldroom.valueObjects.Member) : mx.rpc.AsyncToken
	{
