...
public class _Super_Comment extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        com.goldroom.valueObjects.Member.initRemoteClassAliasSingleChild();
    }
	...
	private var _internal_member : com.goldroom.valueObjects.Member;
	...
	[Bindable(event="propertyChange")] 
    public function get member() : com.goldroom.valueObjects.Member    
    {
    ...
    public function set member(value:com.goldroom.valueObjects.Member) : void 
    {    	
        var recalcValid:Boolean = false;
    	
    	
    	var oldValue:com.goldroom.valueObjects.Member = _internal_member;               
        if (oldValue !== value)
        {
